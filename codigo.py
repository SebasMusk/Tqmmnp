...
def draw_from_json(json_file):
    ...
    update_every_n_lines = 600  # a más líneas entre updates = más velocidad
    ...
    for region in regions:
        ...
        points = region['contour'][::2]  # Si pones [::2] tienes más velocidad, si pones [::1] tienes mas calidad
